...
ALARM_PATH := vendor/clown/prebuilt/common/media/audio/alarms
NOTIFICATION_PATH := vendor/clown/prebuilt/common/media/audio/notifications
RINGTONE_PATH := vendor/clown/prebuilt/common/media/audio/ringtones
