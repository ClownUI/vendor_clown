...
custom_dependencies = "clown.dependencies"
org_manifest = "clownui-devices"  # leave empty if org is provided in manifest
org_display = "ClownUI-Devices"  # needed for displaying

clown_manifest = ".repo/manifests/clown.xml"
...
def add_to_manifest(repos, fallback_branch=None):
    ...
    clownm = load_manifest(custom_manifest)
    ...
    for repo in repos:
        ...
        elif exists_in_tree(clownm, repo_target) != None:
            existing_m_project = exists_in_tree(clownm, repo_target)
