#!/usr/bin/env python
# Copyright (C) 2022-2024 ClownUI Android Project
#
...
custom_default_revision =  "vic"
custom_dependencies = "clown.dependencies"
org_manifest = "clownui"  # leave empty if org is provided in manifest
org_display = "clownui"  # needed for displaying
...
def main():
    ...
    for repository in repositories:
        ...
        adding = [{'repository': "ClownUI/" + repo_name, 'target_path': repo_path}]
